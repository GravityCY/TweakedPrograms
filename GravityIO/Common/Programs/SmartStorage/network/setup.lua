...
NetUtils.saveDownload("https://raw.githubusercontent.com/GravityCY/cc-t/master/GravityIO/Common/Programs/SmartStorage/network/locale/en_us", "/data/smart_storage/locale/en_us");
